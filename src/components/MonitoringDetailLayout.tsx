...
export function MonitoringDetailLayout({
  user,
  title,
  subtitle,
  recordId,
  ...
  message,
  children,
}: MonitoringDetailLayoutProps) {
  return (
    <DashboardLayout title={title} user={user}>
      <div className="max-w-4xl mx-auto space-y-6">
        <Link href={backHref} className="text-sm font-semibold text-emerald-600 hover:text-emerald-800">
          ← Kembali ke daftar
        </Link>
